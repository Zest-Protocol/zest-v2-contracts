...
(define-trait market-trait
  (
    ...
    ;; price-feeds: optional list of up to 3 signed Pyth Lazer update buffers (exactly one is
    ;; verified inline via .pyth-lazer-oracle verify-price-feeds; prices resolve from it)
    ...
    ;; price-feeds: optional list of up to 3 signed Pyth Lazer update buffers (see collateral-add)
