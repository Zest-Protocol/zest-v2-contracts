...
const contractName = "wormhole-core-v4";
const verbosity = 0;

describe("wormhole-core-v4::parse-vaa success", () => {
...
describe("wormhole-core-v4::update-guardians-set failures", () => {
  const accounts = simnet.getAccounts();
...
describe("wormhole-core-v4::update-guardians-set success", () => {
  const accounts = simnet.getAccounts();
  const deployer = accounts.get("deployer")!;
  const sender = accounts.get("wallet_1")!;
...
describe("wormhole-core-v4::parse-and-verify-vaa success", () => {
  const accounts = simnet.getAccounts();
  const deployer = accounts.get("deployer")!;
  const sender = accounts.get("wallet_1")!;
  const guardianSet1Keys = wormhole.generateGuardianSetKeychain(19);
...
describe("wormhole-core-v4::parse-and-verify-vaa failures", () => {
  const accounts = simnet.getAccounts();
  const deployer = accounts.get("deployer")!;
  const sender = accounts.get("wallet_1")!;
  const guardianSet1Keys = wormhole.generateGuardianSetKeychain(19);
...
describe("wormhole-core-v4::update-guardians-set mainnet guardian rotations", () => {
  const accounts = simnet.getAccounts();
  const deployer = accounts.get("deployer")!;
  const sender = accounts.get("wallet_1")!;
